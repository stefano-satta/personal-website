        ...
        <section className="bg-black text-white">
            <Container as="div" className="d-flex flex-column justify-content-between min-vh-100"
                ...
                <div className="h-100 w-100 mx-auto text-center mb-5" style={{maxWidth: '580px'}}>
                    <Image src={MeImg} alt={'myself image'} width={150} priority/>
                    <h1 className="mt-4 mb-0 fw-bold font-archivo-black text-uppercase" style={{fontSize: '3rem'}}>Stefano Satta</h1>
                        ...
                        modern technologies.</p>
                    {
                        LinksBio.map(( item) => (
                            <Link href={item.link}
                                  ...
                                  className="btn btn-lg btn-white rounded-pill mb-3 d-flex position-relative"
                                  key={item.title}
                                  style={{padding: '36px'}}>
