...
const ButtonCustom = (props: ButtonCustomProps) => {
    const {label, iconType = icon.arrowUp, className, style} = props;

    return (
        <Button className={`px-5 d-flex rounded-pill bg-white text-black position-relative ${className}`} style={style} id="button-custom">
