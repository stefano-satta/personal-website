import BlobMail from "@/components/common/blob-mail/BlobMail";
...
const ContactSection = () => {
    ...
    return (
        <section className="pb-5 bg-black text-white">
            <Container>
                <TitleSection title={t('title')} className="mb-4 font-archivo-black"/>

                <Link href={`mailto:${myInfo.email}?subject=New collaboration`}
                      passHref
                      className="me-3">
                    <Pill textColor="light" label={t('pills.newCollab')} className="fs-4 border border-white bg-transparent"/>
                </Link>
                <Link href={`mailto:${myInfo.email}?subject=No coding, only pizza and beer!`}
                      passHref>
                    <Pill textColor="light" label={t('pills.pizza')} className="fs-4 border border-white bg-transparent"/>
                </Link>
